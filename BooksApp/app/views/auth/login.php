...
<main class="container mx-auto px-6 py-10 flex-grow flex items-center justify-center">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white border border-[#f6e6da] rounded-xl overflow-hidden shadow-lg p-8">
            <form action="/WA-2026-Ulrich-Jan/BooksApp/app/controllers/AuthController.php?action=authenticate" method="post">
                ...
                <div class="space-y-6">
                    ...
                    <p class="text-center text-slate-500 text-sm border-t border-slate-700 pt-4">
                        Nemáte ještě účet? <a href="/WA-2026-Ulrich-Jan/BooksApp/app/controllers/AuthController.php?action=register" class="text-emerald-400 hover:text-white transition-colors">Zaregistrujte se</a>.
                    </p>
                </div>
            </form>
        </div>
