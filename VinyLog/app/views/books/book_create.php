...
<main class="container mx-auto px-6 pb-10 pt-6 flex-grow">
    <div class="bg-white border border-[#f6e6da] rounded-xl overflow-hidden shadow-lg p-8">
        <h2 class="text-2xl font-semibold mb-2 text-[#6b291f]">Přidat vinyl</h2>
        <p class="text-[#6b291f] mb-6">Vyplňte formulář pro přidání nového vinylu do databáze.</p>

        <form action="/WA-2026-Ulrich-Jan/VinyLog/app/controllers/VinylController.php" method="post" enctype="multipart/form-data" class="grid gap-4">
            <div class="field">
                <label for="title" class="text-sm font-medium">Název alba <span class="text-[#c1121f]">*</span></label>
                <input type="text" id="title" name="album_name" required class="w-full p-3 rounded-md border border-[#f0ded5]">
            </div>

            <div class="field">
                <label for="author" class="text-sm font-medium">Umělec <span class="text-[#c1121f]">*</span></label>
                <input type="text" id="author" name="artist" required class="w-full p-3 rounded-md border border-[#f0ded5]">
            </div>

            <div class="field">
                <label for="isbn" class="text-sm font-medium">Rok vydání</label>
                <input type="text" id="isbn" name="release_year" class="w-full p-3 rounded-md border border-[#f0ded5]">
            </div>
            ...
            <div class="field grid md:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="price" class="text-sm font-medium">Cena</label>
            ...
            <div class="field md:col-span-2">
                <label class="block text-xs font-semibold text-[#6b291f] mb-2 uppercase tracking-wider">Obrázky alba</label>
                <div class="w-full">
            ...
            <div>
                <button type="submit" class="bg-[#588157] hover:bg-[#3a5a40] text-white px-4 py-2 rounded-md font-bold">Přidat vinyl</button>
            </div>
        </form>
    </div>
